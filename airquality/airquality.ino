...
const char *ssid = "Rohit Rathore 4G";          // Replace with your Wi-Fi network SSID
const char *password = "rmuf6841";  // Replace with your Wi-Fi network password
const char *thingSpeakApiKey = "T6197YPAGQ3KEDS3";  // Replace with your ThingSpeak API key
const unsigned long channelNumber = 2371002;  // Replace with your ThingSpeak channel number
...
void loop() {
  ...
  // You can add additional logic here to control an output based on the sensor readings
  // For example, turn on an LED if the gas concentration or temperature exceeds a certain threshold
...
float readGasConcentration(int pin) {
  ...
  float concentration = 100.0 * voltage;  // Example conversion, may need calibration
...
float readAlcoholConcentration(int pin) {
  int sensorValue = analogRead(pin);
  float voltage = sensorValue * (5.0 / 1023.0);
  float concentration = 10.0 * voltage;  // Example conversion, may need calibration
